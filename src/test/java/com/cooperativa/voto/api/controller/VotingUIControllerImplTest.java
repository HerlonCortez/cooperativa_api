...
class VotingUIControllerImplTest {
    ...
    @BeforeEach
    void setUp() {
        ReflectionTestUtils.setField(votingUIControllerImpl, "baseUrl", BASE_URL);
    }
    ...
    void getScreenFormIdentification_Sucesso() {
        ...
        ResponseEntity<ScreenFormResponseDTO> response = votingUIControllerImpl.getScreenFormIdentification(agendaId);
    ...
    void getScreenSelecion_Sucesso() {
        ...
        ResponseEntity<ScreenSelectionResponse> response = votingUIControllerImpl.getScreenSelecion(request);
