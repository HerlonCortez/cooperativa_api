...
public class AgendaControllerImplTest {
    @InjectMocks
    private AgendaControllerImpl agendaControllerImpl;
    ...
    @BeforeEach
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(agendaControllerImpl).build();
